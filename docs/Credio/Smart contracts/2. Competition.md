...
- Creation time: timestamp of creating competition contract
- Duration: time until the end of the competition
- Staking amounts: amount of token staked to protocol by users
...
- Cancel params for competition creator (phrase A, phrase B, phrase C)
- Return data to Credio (based on template rule, push or pull mechanism)
