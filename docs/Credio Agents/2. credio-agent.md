...
The **Credio Agent** is an autonomous guardian for your Stellar DeFi positions. It watches risk in real time through [OctoPos RMS](../OctoPos%20RMS%20Portfolio%20Risk%20Monitoring%20Services/rms) and closes Blend Capital lending positions the moment risk hits the `emergency` level.
...
2. If missing or near expiry, pays via [X402](/docs/OctoPos/DeFi%20Positions%20API/subscriptions) in Stellar USDC
...
See [RMS Risk Levels](../OctoPos%20RMS%20Portfolio%20Risk%20Monitoring%20Services/rms#risk-levels) for the underlying health-factor bands.
