...
The **Credio Agent** is an autonomous guardian for your Stellar DeFi positions. It watches risk in real time through [OctoPos RMS](https://docs.untangled.finance/docs/octopos/rms/rms) and closes Blend Capital lending positions the moment risk hits the `emergency` level.
...
2. If missing or near expiry, pays via [X402](https://docs.untangled.finance/docs/octopos/defi-positions-api/subscriptions) in Stellar USDC
...
See [RMS Risk Levels](https://docs.untangled.finance/docs/octopos/rms/rms#risk-levels) for the underlying health-factor bands.
