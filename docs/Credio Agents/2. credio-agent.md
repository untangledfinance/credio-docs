...
The **Credio Agent** is an autonomous guardian for your Stellar DeFi positions. It watches risk in real time through [OctoPos RMS](https://docs.untangled.finance/docs/octopos/rms/) and closes Blend Capital lending positions the moment risk hits the `emergency` level.
...
See [RMS Risk Levels](https://docs.untangled.finance/docs/octopos/rms/#risk-levels) for the underlying health-factor bands.
