...
**Credio Agents** are autonomous on-chain agents that watch your Stellar DeFi positions around the clock and act on your behalf when risk becomes critical. They turn [OctoPos](/docs/OctoPos/DeFi%20Positions%20API/intro) risk intelligence into real, timely execution — so your positions stay safe even while you sleep.
...
### Risk Monitoring
Polls the [OctoPos RMS API](../OctoPos%20RMS%20Portfolio%20Risk%20Monitoring%20Services/rms) in real time for each wallet it manages. Risk levels map directly to RMS: `healthy`, `warn`, `alert`, `emergency`.
...
The agent pays for its own OctoPos API access through the [X402 payment protocol](/docs/OctoPos/DeFi%20Positions%20API/subscriptions), using Stellar USDC. Keys are renewed automatically before expiry.
...
| Risk data | [OctoPos RMS](../OctoPos%20RMS%20Portfolio%20Risk%20Monitoring%20Services/rms) |
...
Additional protocols — Aquarius, SoroSwap, Phoenix, FxDAO — are on the roadmap, tracking [OctoPos adapter coverage](/docs/OctoPos/DeFi%20Positions%20API/supported-sources).

## Relationship to OctoPos

| OctoPos Component | Role for the Agent |
|-------------------|--------------------|
| [RMS](../OctoPos%20RMS%20Portfolio%20Risk%20Monitoring%20Services/rms) | Risk signal source |
| [TxB](./txb) | Transaction proposal reference |
| [X402 Subscriptions](/docs/OctoPos/DeFi%20Positions%20API/subscriptions) | Payment rail for API access |
