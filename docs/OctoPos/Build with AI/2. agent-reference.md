...
A dense, copy-friendly reference for AI coding agents (Claude Code, Cursor, Codex, and similar) integrating against OctoPos.
...
Full per-endpoint description, request/response examples, and known limitations: [OctoPos EVM capabilities](../OctoPos%20EVM/capabilities).
...
For full per-endpoint docs: [DeFi Positions API (Stellar)](https://docs.crediolabs.ai/docs/OctoPos/DeFi%20Positions%20API/1.%20intro).
...
**Stellar** — POST to `/v1/webhooks/{goldsky,slack,x402}`. See [Stellar deployment docs](https://docs.crediolabs.ai/docs/OctoPos/DeFi%20Positions%20API/5.%20subscriptions).
...
16 supported chains, 9 deferred. The full table is on [OctoPos EVM supported chains](../OctoPos%20EVM/supported-chains). Quick reference for the 13 default-tag chains that `/v1/evm/balances` expands to without `chain_ids`:
...
**EVM `/v1/evm/balances/:address`** — see [OctoPos EVM capabilities](../OctoPos%20EVM/capabilities#v1evmbalancesaddress).

**Stellar `/v1/positions/:address`** — see [DeFi Positions API (Stellar)](https://docs.crediolabs.ai/docs/OctoPos/DeFi%20Positions%20API/1.%20intro).
...
- [OctoPos EVM overview](../OctoPos%20EVM/overview) — V8.3, deployed URLs, architecture
- [OctoPos EVM capabilities](../OctoPos%20EVM/capabilities) — per-endpoint reference
- [OctoPos EVM supported chains](../OctoPos%20EVM/supported-chains) — 16 + 9 deferred
- [DeFi Positions API (Stellar)](https://docs.crediolabs.ai/docs/OctoPos/DeFi%20Positions%20API/1.%20intro) — Stellar surface
